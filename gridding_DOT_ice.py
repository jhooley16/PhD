...
for year in ['2010', '2011', '2012', '2013', '2014', '2015', '2016']:
    ...
    for file in os.listdir():
        if file[-21:] == 'DOT_track_ice_only.nc':
            print('Gridding: ' + file)
            nc = Dataset(file, 'r')
            ...
            pl.savefig('/Users/jmh2g09/Documents/PhD/Data/Gridded/DOT/'+ year +'/Figures/' 
                + year + month + '_DOT_gridded_ice_only.png', format='png', transparent=True, dpi=300)
            pl.close()
    
            # Put the data in a .nc file in /Users/jmh2g09/Documents/PhD/Data/Gridded     
            nc = Dataset('/Users/jmh2g09/Documents/PhD/Data/Gridded/DOT/' + year + '/' + year + month + '_DOT_ice_only.nc', 'w')
