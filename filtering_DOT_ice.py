...
for year in ['2011', '2012', '2013', '2014', '2015', '2016']:
    for month in ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']:
        ...
        if os.path.isfile(file):
            ...
            pl.savefig('/Users/jmh2g09/Documents/PhD/Data/Gridded/DOT/' + year + '/Figures/' + year + month + '_DOT_filt_ice.png', format='png', transparent=True, dpi=300, bbox_inches='tight')
            pl.close()
