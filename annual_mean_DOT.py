...
c.set_label('DOT (m)')
pl.clim(0, -2.25)
m.contour(stereo_x, stereo_y, np.transpose(np.ma.masked_invalid(ice_mean)), [20, ], colors='k')

pl.savefig('/Users/jmh2g09/Documents/PhD/Data/Gridded/DOT/mean_DOT.png', format='png', transparent=True, dpi=300, bbox_inches='tight')
pl.close()
