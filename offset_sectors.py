                ...
                for line in f:
                    ...
                    if columns[0] == '1' or columns[0] == '2':
                        ...
                        if columns[1] == '1':
                            ...
                            ssh.append(float(columns[7]) - float(columns[8]))
                    ...
                    if surface_type[step - 10:step] == [1] * 10:
                        ...
                        if abs(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10])) < .5:
                            ...
                            if -60. <= np.mean(lon[step - 10:step + 10]) <= 0.:
                                ...
                                hist_offset_WEDD.append(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10]))
                            if 0 <= np.mean(lon[step - 10:step + 10]) <= 160.:
                                #print('Indian')
                                offset_IND.append(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10]))
                                hist_offset_IND.append(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10]))
                            if 160. <= np.mean(lon[step - 10:step + 10]) <= 180.:
                                #print('Ross')
                                offset_ROSS.append(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10]))
                                hist_offset_ROSS.append(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10]))
                            ...
                            if -130. <= np.mean(lon[step - 10:step + 10]) <= -60.:
                                ...
                                hist_offset_AMBEL.append(np.mean(ssh[step - 10:step]) - np.mean(ssh[step:step + 10]))
                    ...
                    if surface_type[step - 10:step] == [2] * 10:
                        ...
                        if abs(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step])) < .5:
                            ...
                            if -60. <= np.mean(lon[step - 10:step + 10]) <= 0.:
                                ...
                                hist_offset_WEDD.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                            if 0 <= np.mean(lon[step - 10:step + 10]) <= 160.:
                                #print('Indian')
                                offset_IND.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                                hist_offset_IND.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                            if 160. <= np.mean(lon[step - 10:step + 10]) <= 180.:
                                #print('Ross')
                                offset_ROSS.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                                hist_offset_ROSS.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                            if -180. <= np.mean(lon[step - 10:step + 10]) <= -130.:
                                #print('Ross')
                                offset_ROSS.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                                hist_offset_ROSS.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
                            if -130. <= np.mean(lon[step - 10:step + 10]) <= -60.:
                                ...
                                hist_offset_AMBEL.append(np.mean(ssh[step:step + 10]) - np.mean(ssh[step - 10:step]))
