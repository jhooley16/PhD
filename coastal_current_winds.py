...
c = m.colorbar()
pl.title('10 m wind anomaly (AMJ - NDJF)')
pl.clim(3, -3)
c.set_label('m s$^{-1}$')
pl.savefig('/Users/jmh2g09/Documents/PhD/Data/CoastalCurrent/wind_anomaly_map.png', format='png', transparent=True, dpi=300)
pl.close()