...
for year in ['2010', '2011', '2012', '2013', '2014', '2015', '2016']:
    ...
    for file in os.listdir():
        if file[-11:] == 'DOT_filt.nc':
            ...
            pl.savefig('Anomalies/Figures/' + str(year) + '_' + str(month) + '_DOT_anomaly.png', format='png', transparent=True, dpi=300, bbox_inches='tight')
            pl.close()
...
for imnth in range(12):
    ...
    pl.savefig('../Figures/' + str(imnth + 1) + '_DOT_anomaly_month.png', format='png', transparent=True, dpi=300, bbox_inches='tight')
    pl.close()