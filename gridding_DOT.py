...
os.chdir('/Users/jmh2g09/Documents/PhD/Data/Raw/' + year + '/DOT_track')
...
for file in os.listdir():
    if file[-12:] == 'DOT_track.nc':
        ...
        data = funct.grid(mdt, lon, lat, .5)
        grid_mdt = data['Grid']
        grid_lon = data['Lon']
        grid_lat = data['Lat']
        
        data = funct.grid(ice_conc, lon, lat, .5)
        grid_ice = data['Grid']
    
        # Put the data in a .nc file in /Users/jmh2g09/Documents/PhD/Data/Gridded

        os.chdir('/Users/jmh2g09/Documents/PhD/Data/Gridded/' + year + '/DOT')
    
        month = file[4:6]
        nc = Dataset(year + month + '_DOT.nc', 'w', format='NETCDF4_CLASSIC')
