...
pl.xlabel('Distance from Antarctic Coast (km)')
pl.ylabel('MDT (m)')
pl.savefig('/Users/jmh2g09/Documents/PhD/Data/CoastalCurrent/zonal_slope_compare.png', format='png', transparent=True, dpi=300, bbox_inches='tight')
pl.close()
...
pl.savefig('/Users/jmh2g09/Documents/PhD/Data/CoastalCurrent/zonal_u_compare.png', format='png', transparent=True, dpi=300, bbox_inches='tight')
pl.close()
