...
pl.plot([date(2011, 8, 1), date(2011, 8, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)
pl.plot([date(2011, 11, 1), date(2011, 11, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)

pl.plot([date(2012, 9, 1), date(2012, 9, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)
pl.plot([date(2012, 11, 1), date(2012, 11, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)

pl.plot([date(2013, 9, 1), date(2013, 9, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)
pl.plot([date(2013, 12, 1), date(2013, 12, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)

pl.plot([date(2014, 9, 1), date(2014, 9, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)
pl.plot([date(2014, 11, 1), date(2014, 11, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)

pl.plot([date(2015, 7, 1), date(2015, 7, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)
pl.plot([date(2015, 10, 1), date(2015, 10, 1)], [-6, 6], color='k', linestyle='--', linewidth=0.5)
